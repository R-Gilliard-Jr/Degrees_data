...
During the course you are going to work primarily in R and much of the work done using R will be done with R Markdown. Don't worry if you are not familiar with the language or with coding at all; this class and the Codecademy course that will supplement it are meant for beginners. If you do have experience with R and feel that the course is moving too slowly or that you are not being sufficiently challenged, I encourage you to 1) Add complexity to the examples and challenges presented in class or on Codecademy, 2) read ahead in the syllabus and work on something that is at your level, or 3) focus extra time on your project. Though there are many other languages used for data analysis (including Python, SAS, Stata, and SQL), you will not explore those. If you'd like to know more about one of them feel free to reach out to me and I am happy to share what I know or help point you to a starting place if I am inexperienced in the language myself. 

## About the instructor

I came to data analytics and R through an unusual path. I started my career as a teacher in private schools, first at San Francisco Day school and then at Collegiate. Education is now and has always been important to me, but I didn't feel that the place that I could deliver the biggest impact was in the classroom. After two years teaching, then, I set off to pursue a master's degree in education policy.

That degree led me to the Research Alliacnce for New York City Schools, where my relationship with #DegreesNYC began, and that position led me to a PhD at Teachers College, Columbia University in the Economics and Education program. Currently, I am a Data Analytics Developer at [Mathematica](https://www.mathematica.org/). I have experience using SAS, SQL, Stata, R, and Python (as well as tools like Excel), but I am most well versed in R and Stata.

Outside of the work I do I enjoy reading; playing sports, video games, and board games; trying new restaurants, and generally spending time with my friends and family.
...
Unit 2 will be dedicated to a project that encourages you to complete analysis of a data set of your choice from start to finish. You will take the data set through the following stages:

* Research Question Creation

  + Brainstorm some questions that you are curious about and want to spend some time exploring. Many of you are students or are already working in the research field; you're encouraged to bring questions that are relevant for your work or your classes.
...
* Data Identification
  ...
  + If you begin your search early enough, it's possible to find public data on just about anything. If the sources listed here don't meet your needs, reach out and we can search for something that interests you.
...
* Data Analysis
  ...
  + Provide some basic descriptive statistics on the data set. Use the mean, median, min, max, to describe variables of interest in your data set.
  + Use kableExtra for tables as an extension
  + Run regressions/anovas as an extension

* Data Visualization

  + Visualize with ggplot
  + Visualize with kable/kableExtra
  + For an extension, create a shiny dashboard.
...
* [Codecademy Lesson](https://www.codecademy.com/courses/learn-r/lessons/introduction-to-r/exercises/why-r)
